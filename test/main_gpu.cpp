...
int main(int argc, char * argv[]) {
    ...
    Kokkos::initialize(argc, argv);
    {
        ...
        // All Nodes 
        mesh.add_all_points(0, {0.0, 0.0}, mesh.host_points_);
        mesh.add_all_points(1, {0.5, 0.0}, mesh.host_points_);
        mesh.add_all_points(2, {0.5, 0.25}, mesh.host_points_);
        mesh.add_all_points(3, {0.25, 0.375}, mesh.host_points_);
        mesh.add_all_points(4, {0.0, 0.25}, mesh.host_points_);
        mesh.add_all_points(5, {0.875, 0.25}, mesh.host_points_);
        mesh.add_all_points(6, {1.0, 0.375}, mesh.host_points_);
        mesh.add_all_points(7, {0.875, 0.625}, mesh.host_points_);
        mesh.add_all_points(8, {0.5, 0.625}, mesh.host_points_);
        mesh.add_all_points(9, {0.5, 0.875}, mesh.host_points_);
        mesh.add_all_points(10, {0.875, 0.875}, mesh.host_points_);

        // Pentagon
        mesh.add_edge(0, 0, {0, 1}, mesh.host_cells_);
        mesh.add_edge(0, 1, {1, 2}, mesh.host_cells_);
        mesh.add_edge(0, 2, {2, 3}, mesh.host_cells_);
        mesh.add_edge(0, 3, {3, 4}, mesh.host_cells_);
        mesh.add_edge(0, 4, {4, 0}, mesh.host_cells_);

        // Triangle
        mesh.add_edge(1, 0, {1, 5}, mesh.host_cells_);
        mesh.add_edge(1, 1, {5, 2}, mesh.host_cells_);
        mesh.add_edge(1, 2, {2, 1}, mesh.host_cells_);

        // Hexagon
        mesh.add_edge(2, 0, {2, 5}, mesh.host_cells_);
        mesh.add_edge(2, 1, {5, 6}, mesh.host_cells_);
        mesh.add_edge(2, 2, {6, 7}, mesh.host_cells_);
        mesh.add_edge(2, 3, {7, 8}, mesh.host_cells_);
        mesh.add_edge(2, 4, {8, 3}, mesh.host_cells_);   
        mesh.add_edge(2, 5, {3, 2}, mesh.host_cells_);   

        // Square
        mesh.add_edge(3, 0, {8, 7}, mesh.host_cells_);
