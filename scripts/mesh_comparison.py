...
plt.plot(total_cells, timed_values_clipping, marker='^', linestyle='-', label='CLIPPING CELLS', color='green')
plt.plot(total_cells, timed_values_clipped_transfer_2, marker='d', linestyle='-', label='CLIPPED PART: GPU-TO-CPU TRANSFER', color='red')

plt.ylabel("Time (ms)")
plt.xlabel("Number of Cells Clipped")
plt.title("Runtime Analysis of all Kokkos Regions\nin a 0.08 Unit Mesh")
plt.grid(True)
