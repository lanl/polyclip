...
def main():
    ...
    with open("poly_legacy_horizontal.txt", "w") as file:
        pass

    with open("poly_legacy_horizontal.txt", "a") as file:
        for i in legacy_horizontal:
            file.write("0,1 " + str(i) + "\n")

    with open("poly_legacy_vertical.txt", "w") as file:
        pass

    with open("poly_legacy_vertical.txt", "a") as file:
        for i in legacy_vertical:
            file.write("1,0 " + str(i) + "\n")

    with open("poly_legacy_arbitrary.txt", "w") as file:
        pass

    with open("poly_legacy_arbitrary.txt", "a") as file:
        for i in legacy_arbitrary:
            file.write("1,0 " + str(i) + "\n")

    with open("poly_arbitrary.txt", "w") as file:
        pass

    with open("poly_arbitrary.txt", "a") as file:
    ...
    with open("poly_horizontal.txt", "w") as file:
        pass

    with open("poly_horizontal.txt", "a") as file:
        for i in horizontal:
            file.write("0,1" + str(i) + "\n")

    with open("poly_diagonal.txt", "w") as file:
        pass

    with open("poly_diagonal.txt", "a") as file:
        for i in horizontal:
